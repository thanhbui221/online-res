                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="beta-products-list">
                            ...
                            <div class="row">
                                @foreach($search_product as $s_p)
                                    <div class="col-sm-3">
                                        <div class="single-item">
                                            <div class="single-item-header">
                                                <a href="product.html"><img src="source/image/product/{{$s_p->image}}" alt="" height="200px"></a>
                                            </div>
                                            <div class="single-item-body">
                                                <p class="single-item-title"><b>{{$s_p->name}}</b></p>
                                                <p class="single-item-price">
                                                    <span><b>{{$s_p->unit_price}}</b></span>
                                                </p>
                                            </div>
                                            <div class="single-item-caption">
                                                <a class="add-to-cart pull-left" href="{{route('add-to-cart',$s_p->id)}}"><i class="fa fa-shopping-cart"></i></a>
                                                <a class="beta-btn primary" href="{{route('product-detail',$s_p->id)}}">Детали <i class="fa fa-chevron-right"></i></a>
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
                                    </div>
